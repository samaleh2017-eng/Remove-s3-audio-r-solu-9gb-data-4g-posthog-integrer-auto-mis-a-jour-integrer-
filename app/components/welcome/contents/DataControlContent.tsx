        ...
        <div className="flex flex-col h-full min-h-[400px] justify-between py-12">
          <div className="mt-8">
            ...
            <div className="flex flex-col gap-4 my-8 pr-24">
              <div
                className={`border rounded-xl p-4 cursor-pointer transition-all ${shareAnalytics ? 'border-emerald-200 bg-emerald-50' : 'border-[var(--border)] bg-[var(--card)] hover:bg-[var(--muted)]'}`}
              ...
              <div
                className={`border rounded-xl p-4 cursor-pointer transition-all ${!shareAnalytics ? 'border-[var(--ring)] bg-[var(--ring-soft)]' : 'border-[var(--border)] bg-[var(--card)] hover:bg-[var(--muted)]'}`}
              ...
              >
                <div className="flex items-center justify-between w-full mb-2">
                  ...
                  {!shareAnalytics && (
                    <div>
                      <Lock
                        style={{ color: 'var(--ring)', width: 18, height: 18 }}
                      />
                    </div>
                  )}
                </div>
