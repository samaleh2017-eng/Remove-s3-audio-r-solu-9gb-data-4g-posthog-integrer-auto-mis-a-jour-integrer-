...
import {
  performanceMonitor,
  PerformanceMetrics,
} from '@/app/performance/performance.monitor'
...
const TIER_OPTIONS: {
...
}[] = [
  {
    id: 'auto',
    label: 'Auto',
    description: 'Automatically selects the best mode for your hardware.',
  },
  {
    id: 'low',
    label: 'Low',
    description:
      'Optimized for machines with limited resources. Disables visual effects for smoother performance.',
  },
  {
    id: 'balanced',
    label: 'Balanced',
  ...
  },
  {
    id: 'high',
    label: 'High',
    description: 'Full visual fidelity with all effects enabled.',
  },
  {
    id: 'ultra',
    label: 'Ultra',
    description: 'Maximum quality with 120 FPS cap and premium effects.',
  },
]

export default function PerformanceSettingsContent() {
  const { userSelectedTier, activeTier, detectedTier, hardwareInfo, setTier } =
    usePerformanceStore()

  const [pendingTier, setPendingTier] =
    useState<PerformanceTier>(userSelectedTier)
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="text-xs text-[var(--color-subtext)] mb-3">
              Choose how Ito manages visual effects and animations. Auto mode
      ...
      {hardwareInfo && (
        <div>
          <div className="text-lg font-sans font-normal mb-4">
            Your Hardware
          </div>
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-[var(--color-subtext)] mt-1">
                  Graphics capability (0–100).
                </div>
              </div>
              <span className="text-sm text-[var(--color-subtext)]">
                {hardwareInfo.gpuScore} / 100
              </span>
            </div>
          </div>
        </div>
